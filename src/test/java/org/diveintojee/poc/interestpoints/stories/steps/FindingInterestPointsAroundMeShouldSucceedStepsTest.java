 ...
 */
public class FindingInterestPointsAroundMeShouldSucceedStepsTest {

    private FindingInterestPointsAroundMeShouldSucceedSteps underTest = null;

    @Before
    public void before() {
        underTest = new FindingInterestPointsAroundMeShouldSucceedSteps();
    }
